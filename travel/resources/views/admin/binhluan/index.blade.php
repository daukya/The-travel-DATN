                            ...
                            <div class="content table-responsive table-full-width">
                                ...
                                <table class="table table-striped" border="1">
                                    <thead>
                                        ...
                                        <input onclick="return confirm('Bạn có chắc chắn muốn xóa')" type="submit" name="sub" value="xóa nhiều" />
                                        </th>
                                        <th>ID_BL</th>
                                    	<th>ID_CT</th>
                                    	<th>Tên</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                        	...
                                        	<td>
                                        		<a onclick="return confirm('Bạn có chắc chắn muốn xóa')" href="{{ route('admin.binhluan.del',['id' => $objItem->id_bl]) }}"><img src="{{ $urlAdmin }}/img/del.gif" alt="" /> Xóa</a>
                                        	</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
...
@section('js')
    <script type="text/javascript">    
        ...
        alert("Bạn chắc chắn muốn duyệt bình luận");
        $.ajax({
